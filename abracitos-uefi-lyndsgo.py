...
if DARK_MODE:
    ...
    COLOR_ACCENT = "#b4befe"  # Tono lavanda/azul-morado suave
    ...
    COLOR_ACCENT = "#6c5ce7"  # Tono azul-morado vibrante
...
grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=LyndsGO --recheck
"""
...
apt-get install -y linux-image-amd64 sudo network-manager console-setup plymouth plymouth-themes ca-certificates dbus {grub_packages}
